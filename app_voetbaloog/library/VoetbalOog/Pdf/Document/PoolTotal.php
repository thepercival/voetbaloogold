...
class VoetbalOog_Pdf_Document_PoolTotal extends Zend_Pdf
{
	...
	public function getUserBetColumnWidthMinimal()
	{
		return $this->m_nUserBetColumnWidthMinimal;
	}
	public function getUserBetColumnWidth()
	{
		return $this->m_nUserBetColumnWidth;
	}
	public function getUserBetColumnWidthMax()
	{
		return 2 * $this->getUserBetColumnWidth();
	}
	public function getUserPointColumnWidth()
	{
		return $this->m_nUserPointColumnWidth;
	}
	public function getUserPointColumnWidthMax()
	{
		return 2 * $this->getUserPointColumnWidth();
	}
	public function canShowImageForQualify()
	{
		return $this->m_bShowImageForQualify;
	}
	public function putShowImageForQualify($bShowImageForQualify)
	{
		$this->m_bShowImageForQualify = $bShowImageForQualify;
	}
